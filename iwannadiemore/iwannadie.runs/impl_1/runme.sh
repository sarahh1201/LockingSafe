...
HD_PWD='C:/Users/ivail/VivadoStuff/LockingSafe-main/iwannadiemore/iwannadie.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log safe_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source safe_top.tcl -notrace
