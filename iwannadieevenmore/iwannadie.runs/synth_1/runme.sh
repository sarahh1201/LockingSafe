...
HD_PWD='C:/Users/shy_h/Documents/github/LockingSafe/iwannadiemore/iwannadie.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log safe_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source safe_top.tcl
