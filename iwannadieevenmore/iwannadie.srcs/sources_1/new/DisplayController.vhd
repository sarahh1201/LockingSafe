...
-- Each lock/unlock command runs for a timed burst (2 seconds) then stops
...
architecture Behavioral of servo is
    ...
    -- Internal counters
    signal counter          : integer range 0 to frameTicks := 0; -- counts within each 20 ms frame
    ...
    begin
        if reset = '1' then
            ...
            if lock = '1' then
                ...
                -- Input released: hold neutral and reset duration counter
                highLim          <= neutralTicks;
                duration_counter <= 0;
            end if;
